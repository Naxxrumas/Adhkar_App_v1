...
import { UserPlus, Mail, Lock, Phone, User, Eye, EyeOff, Sparkles, ArrowLeft } from 'lucide-react';
...
const Register = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-4 relative overflow-hidden" dir="rtl">
            ...
            <div className="absolute top-0 left-0 w-72 h-72 bg-emerald-200 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-pulse" />
            <div className="absolute bottom-0 right-0 w-72 h-72 bg-teal-200 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-pulse" style={{ animationDelay: '2s' }} />
            <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-cyan-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse" style={{ animationDelay: '4s' }} />
            ...
            <div className="w-full max-w-sm relative z-10">
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-slate-500 text-sm mt-1">انضم إلى مُسابقَة وتابع أعمالك</p>
                ...
                <div className="p-6 bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-slate-200/50 border border-white/50">
                    ...
                    <div className="mt-6 pt-5 border-t border-slate-100 text-center">
                        <p className="text-sm text-slate-500">
                            لديك حساب بالفعل؟{' '}
                            <Link to="/login" className="text-emerald-600 font-bold hover:text-emerald-700 transition inline-flex items-center gap-1">
                                تسجيل الدخول
                                <ArrowLeft size={14} />
                            </Link>
                        </p>
